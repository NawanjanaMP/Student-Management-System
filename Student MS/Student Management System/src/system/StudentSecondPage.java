...
public class StudentSecondPage {
	...
	private void initialize() {
		...
		lblScience_1_2.setBounds(362, 287, 146, 34);
		...
		txtTotalMarks.setBounds(499, 287, 128, 34);
		...
		lblScience_1_1_1.setBounds(362, 331, 146, 34);
		...
		txtAverage.setBounds(499, 331, 128, 34);
		...
		lblScience_1_1_1_1.setBounds(362, 375, 146, 34);
		...
		txtRanking.setBounds(499, 375, 128, 34);
		panel.add(txtRanking);
		
		txtGender = new JTextField();
		txtGender.setFont(new Font("Tahoma", Font.PLAIN, 15));
		txtGender.setColumns(10);
		txtGender.setBounds(177, 229, 145, 34);
		panel.add(txtGender);
		...
		txtTranscript.setFont(new Font("Monospaced", Font.PLAIN, 12));
		...
		btnResult.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(R[7]>=80) {
					txtRanking.setText("1st class");
				}
				if(R[7]>=75 && R[7]<80) {
					txtRanking.setText("2nd upper class ");
				}
				if(R[7]>=70 && R[7]<75) {
					txtRanking.setText("2nd lower class ");
				}
				if(R[7]<70) {
					txtRanking.setText("No class ");
				}
